...
contract Exchange is HederaTokenService {
    ...
    function makeOrder(address _tokenGet, int64 _amountGet, address _tokenGive, int64 _amountGive) public {
        orderCount = orderCount.add(1);
        orders[orderCount] = _Order(orderCount, msg.sender, _tokenGet, _amountGet, _tokenGive, _amountGive, block.timestamp);
        emit Order(orderCount, msg.sender, _tokenGet, _amountGet, _tokenGive, _amountGive, block.timestamp);
    }

    function cancelOrder(int64 _id) public {
    ...
    function fillOrder(int64 _id) public {
    ...
    function _trade(int64 _orderId, address _user, address _tokenGet, int64 _amountGet, address _tokenGive, int64 _amountGive) internal {
        int64 _feeAmount = _amountGive.mul(feePercent).div(100);
